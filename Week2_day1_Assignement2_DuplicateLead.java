...
public class Week2_day1_Assignement2_DuplicateLead {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			driver1.findElement(By.id("createLeadForm_companyName")).sendKeys("Balu Ltd");
			driver1.findElement(By.id("createLeadForm_firstName")).clear();
			driver1.findElement(By.id("createLeadForm_firstName")).sendKeys("Balu");
			driver1.findElement(By.name("submitButton")).click();
			System.out.println(driver1.getTitle());
	}
